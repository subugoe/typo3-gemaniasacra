...
$TCA['tx_germaniasacra_domain_model_kloster'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, kloster, kloster_id, patrozinium, bemerkung, band_seite, text_gs_band, band, url, standort, bearbeitungsstatus, personallistenstatus, orden',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, kloster, kloster_id, patrozinium, bemerkung, band_seite, text_gs_band, band, url, standort, bearbeitungsstatus, personallistenstatus, orden,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),

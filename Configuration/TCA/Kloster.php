...
$TCA['tx_germaniasacra_domain_model_kloster'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, kloster, kloster_id, patrozinium, bemerkung, band_seite, text_gs_band, bearbeitungsstatus, personallistenstatus, band, url, standort',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, kloster, kloster_id, patrozinium, bemerkung, band_seite, text_gs_band, bearbeitungsstatus, personallistenstatus, band, url, standort,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'standort' => array(
			...
			'config' => array(
				...
				'MM' => 'tx_germaniasacra_kloster_klosterstandort_mm',
				'size' => 10,
				'autoSizeMax' => 30,
				'maxitems' => 9999,
				'multiple' => 0,
				'wizards' => array(
					...
					'add' => Array(
						...
						'icon' => 'add.gif',
						'params' => array(
							'table' => 'tx_germaniasacra_domain_model_klosterstandort',
							'pid' => '###CURRENT_PID###',
							'setValue' => 'prepend'
							),
						'script' => 'wizard_add.php',
